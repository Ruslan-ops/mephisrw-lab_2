...
func (h *Handler) InitRoutes() *gin.Engine {
	...
	router.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"https://mephi22.undersite.ru", "https://mephi71.ru", "https://mephi71.ru:9083", "http://127.0.0.1:9000", "http://localhost:9000", "http://127.0.0.1:9001", "http://localhost:9001", "http://localhost:9002", "http://127.0.0.1:9002", "http://localhost:9003", "http://127.0.0.1:9003"},
